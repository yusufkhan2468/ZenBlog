      ...
      <div class="col-md-9">
        ...
        <div class="d-md-flex post-entry-2 small-img">
          <a href="single-post.html" class="me-4 thumbnail">
            <img src="{{('assets/frontend')}}/img/post-landscape-6.jpg" alt="" class="img-fluid">
          </a>
          <div>
            ...
            <div class="d-flex align-items-center author">
              <div class="photo"><img src="{{('assets/frontend')}}/img/person-2.jpg" alt="" class="img-fluid"></div>
              <div class="name">
        ...
        <div class="d-md-flex post-entry-2 small-img">
          <a href="single-post.html" class="me-4 thumbnail">
            <img src="{{('assets/frontend')}}/img/post-landscape-3.jpg" alt="" class="img-fluid">
          </a>
          <div>
            <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
        ...
        <div class="d-md-flex post-entry-2 small-img">
          <a href="single-post.html" class="me-4 thumbnail">
            <img src="{{('assets/frontend')}}/img/post-landscape-4.jpg" alt="" class="img-fluid">
          </a>
          <div>
            <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
        ...
        <div class="aside-block">
          ...
          <div class="video-post">
            <a href="https://www.youtube.com/watch?v=AiFfDjmd0jU" class="glightbox link-video">
              ...
              <img src="{{('assets/frontend')}}/img/post-landscape-5.jpg" alt="" class="img-fluid">
            </a>
          </div>
        </div><!-- End Video -->
