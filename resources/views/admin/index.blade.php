                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('{{asset('assets/frontend')}}/img/post-slide-1.jpg');">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('{{asset('assets/frontend')}}/img/post-slide-2.jpg');">
                                        <div class="img-bg-inner">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('{{asset('assets/frontend')}}/img/post-slide-3.jpg');">
                                        <div class="img-bg-inner">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('{{asset('assets/frontend')}}/img/post-slide-4.jpg');">
                                        <div class="img-bg-inner">
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="{{asset('assets/frontend')}}/img/post-landscape-1.jpg"
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{asset('assets/frontend')}}/img/person-1.jpg" alt=""
                                        class="img-fluid"></div>
                                <div class="name">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{asset('assets/frontend')}}/img/post-landscape-2.jpg" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{asset('assets/frontend')}}/img/post-landscape-5.jpg" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{asset('assets/frontend')}}/img/post-landscape-7.jpg" alt=""
                                            class="img-fluid"></a>
                            ...
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{asset('assets/frontend')}}/img/post-landscape-3.jpg" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{asset('assets/frontend')}}/img/post-landscape-6.jpg" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{asset('assets/frontend')}}/img/post-landscape-8.jpg" alt=""
                                            class="img-fluid"></a>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-lg-flex post-entry-2">
                            <a href="single-post.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                                <img src="{{asset('assets/frontend')}}/img/post-landscape-6.jpg" alt=""
                                    class="img-fluid">
                            </a>
                            <div>
                                ...
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="{{asset('assets/frontend')}}/img/person-2.jpg" alt=""
                                            class="img-fluid"></div>
                                    <div class="name">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="post-entry-1 border-bottom">
                                    <a href="single-post.html"><img
                                            src="{{asset('assets/frontend')}}/img/post-landscape-1.jpg" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Culture</span> <span
                                            class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                    ...
                    <div class="col-md-9 order-md-2">
                        ...
                        <div class="d-lg-flex post-entry-2">
                            <a href="single-post.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                                <img src="{{asset('assets/frontend')}}/img/post-landscape-3.jpg" alt=""
                                    class="img-fluid">
                            </a>
                            <div>
                                <div class="post-meta"><span class="date">Business</span> <span
                                ...
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="{{asset('assets/frontend')}}/img/person-4.jpg" alt=""
                                            class="img-fluid"></div>
                                    <div class="name">
                                        <h3 class="m-0 p-0">Wade Warren</h3>
                                    </div>
        ...
        <section class="category-section">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="{{asset('assets/frontend')}}/img/post-landscape-8.jpg"
                                    alt="" class="img-fluid"></a>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{asset('assets/frontend')}}/img/person-7.jpg" alt=""
                                        class="img-fluid"></div>
                                <div class="name">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{asset('assets/frontend')}}/img/post-landscape-4.jpg" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Lifestyle</span> <span
                                            class="mx-1">&bullet;</span> <span>Mar 15th '22</span></div>
                                    <h2><a href="single-post.html">Why Craigslist Tampa Is One of The Most Interesting
